...
/*
 * Function simulating actual business logic.
 */
void perform_workload(ocf_core_t core)
{
	 ...
	 * performing read we retrive written data. Because our example data
	 * object completes io synchronously, there is no need to wait in
	 * this case.
	 */
